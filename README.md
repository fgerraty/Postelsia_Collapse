...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18274746.svg)](https://doi.org/10.5281/zenodo.18274746)
...
*Note:* *Due to the conservation status of Postelsia palmaeformis, we removed all site-specific metadata from all publicly-available data and code. Because of this, R scripts to produce the map figures (Figure 2B and S3) are not published in this repository*.
